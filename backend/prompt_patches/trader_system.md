> **NO PLACEHOLDER VARIABLES: Do NOT write "$X", "$Y", "[amount]", or any unfilled template variable in your output. If a dollar amount is not computable, omit it entirely rather than leaving a placeholder. Write "Sizing: 15% of portfolio" not "Sizing: 15% of your portfolio or $X".**
